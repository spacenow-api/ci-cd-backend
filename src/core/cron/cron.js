...
import { fixerAPIAccessKey } from "../../config";
...
const cron = app => {
	...
	new CronJob("0 0 0 * * *", async function() {
      ...
      const URL = `http://data.fixer.io/api/latest?access_key=${fixerAPIAccessKey}&base=${symbol}`;
      ...
      let baseData = { currencyCode: symbol, rate: 1.0, isBase: true };
