...
class BookingRequestHost extends React.Component {
  ...
  render() {
    ...
    const { content: {reservationId, confirmationCode, hostName, guestName, checkIn, checkOut} } = this.props;
              ...
              <TBody>
                <TR>
                  <TD style={textStyle}>
                    ...
                    <div>
                      {guestName} will stay in the {listTitle} from {checkInDate} to {checkOutDate}.
                    </div>
                    <EmptySpace height={10} />
                    <div>
