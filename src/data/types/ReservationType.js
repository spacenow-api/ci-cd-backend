...
// Models
import {Listing, UserProfile, Threads, Payout, TransactionHistory, Transaction, CancellationDetails,User} from '../models';
...
const ReservationType = new ObjectType({
    ...
    fields: {
        ...
        cancellationDetails: {
            ...
            resolve (reservation) {
                return CancellationDetails.findOne({ where: { 
                        reservationId: reservation.id
                    } 
                });
            }
